...
export class GeografiaService {
  ...
  devolverMicroredPorRed(cod_red: string) {
    return this.http.get<any>(environment.ipmicroservicios + 'distritos/microredes/' + cod_red);
  }
  devolverIpressPorMicrored(cod_microred: string) {
    return this.http.get<any>(environment.ipmicroservicios + 'distritos/microred/' + cod_microred+'/ipress');
  }
}
