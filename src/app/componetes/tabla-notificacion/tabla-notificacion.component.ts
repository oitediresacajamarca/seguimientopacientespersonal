import { Component, OnInit, ɵConsole, Input, Output, EventEmitter, AfterViewInit } from '@angular/core';
...
export class TablaNotificacionComponent implements OnInit,AfterViewInit {
  pacientes: any[];
  ...
  cargarNotificaciones() {
    this.elementosmenu = [
      {
        label: 'Registrar Atencion', icon: 'pi-user-edit', command: (event) => {
